...
def main():
    ...
    serialization_tests = repository_root / "datasketches" / "tests" / "serialization_tests"
    generated_targets = {
        "cpp": serialization_tests / "cpp_generated_files",
        "java": serialization_tests / "java_generated_files",
    }
